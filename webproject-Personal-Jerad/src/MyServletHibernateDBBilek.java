...
@WebServlet("/MyServletHibernateDBBilek")
public class MyServletHibernateDBBilek extends HttpServlet implements Info{
   private static final long serialVersionUID = 1L;

   public MyServletHibernateDBBilek() {
      super();
   }
   ...
   void retrieveDisplayData(PrintWriter out) {
      ...
      out.println("<ul>");
      List<TaskBilek> listTasks = UtilDBBilek.listTasks();
